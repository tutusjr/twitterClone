  ...
  return (
    <div className="px-2.5 gap-3 py-2 border-b relative border-[color:var(--background-third)] before:transition-colors flex before:absolute before:inset-0 before:hover:bg-[color:var(--background-secondary)] before:opacity-50 before:z-[-1] cursor-pointer">
      ...
      <div className="flex-1 mb-0.5">
        <header className="leading-5 flex items-center gap-2">
          ...
          <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-[color:var(--color-base-secondary)] hover:text-[#1d9bf0] hover:bg-[#1d9bf01a] rounded-full text-[0.813rem]">
          <svg viewBox="0 0 24 24" className="w-[1.172rem]"><path fill="currentColor" d="M3 12c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm9 2c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm7 0c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/></svg>
          </div>
          </div>
        </header>
        <div>
...
>>>>>>> cbdf0925f851f9e5f7903cee19ea45ed51a42047
          ...
          <div className="flex -ml-1.5 mt-1.5">
            ...
            <div className="text-[color:var(--color-base-secondary)] transition-colors w-[2.172rem] h-[2.172rem] flex items-center justify-center hover:text-[#1d9bf0] hover:bg-[#1d9bf01a] rounded-full">
            <svg viewBox="0 0 24 24" className="w-[1.172rem]">
                <path
                fill="currentColor" 
                d="M4 4.5C4 3.12 5.119 2 6.5 2h11C18.881 2 20 3.12 20 4.5v18.44l-8-5.71-8 5.71V4.5zM6.5 4c-.276 0-.5.22-.5.5v14.56l6-4.29 6 4.29V4.5c0-.28-.224-.5-.5-.5h-11z"/></svg>
            </div>
            <div className="text-[color:var(--color-base-secondary)] transition-colors w-[2.172rem] h-[2.172rem] flex items-center justify-center hover:text-[#1d9bf0] hover:bg-[#1d9bf01a] rounded-full">
            <svg viewBox="0 0 24 24" className="w-[1.172rem]">
                <path
                fill="currentColor" 
                d="M12 2.59l5.7 5.7-1.41 1.42L13 6.41V16h-2V6.41l-3.3 3.3-1.41-1.42L12 2.59zM21 15l-.02 3.51c0 1.38-1.12 2.49-2.5 2.49H5.5C4.11 21 3 19.88 3 18.5V15h2v3.5c0 .28.22.5.5.5h12.98c.28 0 .5-.22.5-.5L19 15h2z"/></svg>
            </div>
          </div>
        </div>
      </div>
