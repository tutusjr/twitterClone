    ...
    switch (photos.length){
        ...
        case 3:return(
            <div className="mt-3 grid grid-cols-2 gap-0.5 h-[288px] border border-[color:var(--background-third)] rounded-2xl overflow-hidden">
                ...
                <div className="flex-1 inset-0 relative">
                <img src={photos[1]} alt="" className=" h-full absolute w-full object-cover "/>
                </div>
                <div className="flex-1 inset-0 relative">
                <img src={photos[2]} alt="" className=" h-full absolute w-full object-cover "/>
                </div>
                </div>
            </div>
        )
