    ...
    >
      <label className=" group h-[43px] rounded-full bg-[color:var(--background-secondary)] border border-transparent relative w-full focus-within:bg-[color:var(--background-primary)] focus-within:border-[#1d9bf0] cursor-text label">
        <div className="w-[56px] h-full flex items-center justify-center absolute top-0 left-0">
          <svg
            viewBox="0 0 24 24"
            className="text-[color:var(--color-base-secondary)] h-[1.172rem] min-w-[32px] absolute group-focus-within:text-[color:var(--color-primary)] cursor-default"
          >
            <path
              fill="currentColor"
        ...
        <input
          ...
          className="w-full h-full bg-transparent outline-none rounded-full pl-[56px]"
        />
        {(query && focus) && (
          <button
            type="button"
          ...
          >
            <svg viewBox="0 0 15 15" className="h-[0.625rem]">
              <path
                fill="currentColor"
